                                ...
                                <div className="row">
                                    <div className="col-xl-5 col-lg-7 col-md-12">
                                        <div className="trv-we-recommend-content">
                                            {/* TITLE START*/}
                                            <div
                                                className="section-head trv-head-title-wrap left-position"
                                            >
                                                <h2 className="trv-head-title">
                                                    We
                                                    <span className="site-text-yellow">Recommend </span>Beautiful Destinations Every Month
                                                </h2>
                                    ...
                                    <div
                                        className="col-xl-7 col-lg-5 col-md-12 trv-we-rec-media-main-wrap"
                                    >
                    ...
                    <div className="trv-most-fav-tour-mid">
                        <div className="trv-most-fav-tour-top">
                            <div className="trv-most-fav-tour-t-left">
                                <div
                                    className="section-head trv-head-title-wrap left-position with-bg-dark"
                                >
                                    <h2 className="trv-head-title">
                                    ...
                                    <div className="swiper-wrapper">
                                        ...
                                        <div className="swiper-slide">
                                            <div className="trv-mf-tour-bx1">
                                                ...
                                                <h3 className="trv-title">
                                                    <a href="destination-detail.html">Tripura</a>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="trv-mf-tour-bx1">
                                                ...
                                                <h3 className="trv-title">
                                                    <a href="destination-detail.html">Coorg</a>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="trv-mf-tour-bx1">
                                                ...
                                                <h3 className="trv-title">
                                                    <a href="destination-detail.html">Agra</a>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="trv-mf-tour-bx1">
                                                ...
                                                <h3 className="trv-title">
                                                    <a href="destination-detail.html">Banglore</a>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="trv-mf-tour-bx1">
                                                ...
                                                <h3 className="trv-title">
                                                    <a href="destination-detail.html">Barsana</a>
                                                    <span>20 Listing</span>
                                                </h3>
                                            </div>
                                        </div>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="trv-mf-tour-bx1">
                                                ...
                                                <h3 className="trv-title">
                                                    <a href="destination-detail.html">Kanyakumari</a>
                                                    <span>20 Listing</span>
                                                </h3>
                                            </div>
                                        </div>
                    ...
                    <div className="container">
                        ...
                        <div className="section-content">
                            <div className="trv-gradi-text">
                                Testimonial
                                <img
                                    src="/images/airplane-takeoff1.png"
                                    alt="Image"
                                />
                            </div>
                                                ...
                                                <div className="info">
                                                    <div className="trv-testimo-head">
                                                        <div className="left-part">
                                                            <h4 className="trv-testimonial-name">Amelia Warner</h4>
                                                            <span className="trv-testimonial-position">Tourist</span>
                                                        </div>
                                                        <div className="right-part">
                                                            <img src="/images/trv-icon/Quote.png" alt="quote" />
                                                        </div>
                                                    </div>
                                                    <p>
                                                        Once the travel bug bites, there is no known antidote,
                                                        and I know that I shall be happily infected until the
                                                        end of my life.
                                                    </p>
                                        ...
                                        <div className="swiper-slide">
                                            <div className="trv-testimo-bx2">
                                                ...
                                                <div className="info">
                                                    <div className="trv-testimo-head">
                                                        <div className="left-part">
                                                            <h4 className="trv-testimonial-name">Kavin Martin</h4>
                                                            <span className="trv-testimonial-position">Traveler</span>
                                                        </div>
                                                        <div className="right-part">
                                                            <img src="/images/trv-icon/Quote.png" alt="quote" />
                                                        </div>
                                                    ...
                                                    <p>
                                                        Booking was smooth and the trip was perfectly planned.
                                                        Highly recommended!
                                                    </p>
                                                    <div className="rating">
                                                        <i className="bi bi-star-fill"></i>
                                    ...
                                    <div className="swiper-wrapper">
                                        <div className="swiper-slide">
                                            <div className="trv-testimo-bx2-thumb">
                                                <img src="/images/trv-testimonial2/pic1.jpg" alt="thumb" />
                                            </div>
                                        </div>
                                        <div className="swiper-slide">
                                            <div className="trv-testimo-bx2-thumb">
                                                <img src="/images/trv-testimonial2/pic2.jpg" alt="thumb" />
                                            </div>
                                        </div>
                                        <div className="swiper-slide">
                                            <div className="trv-testimo-bx2-thumb">
                                                <img src="/images/trv-testimonial2/pic3.jpg" alt="thumb" />
                                            </div>
                                        </div>
                                        <div className="swiper-slide">
                                            <div className="trv-testimo-bx2-thumb">
                                                <img src="/images/trv-testimonial2/pic4.jpg" alt="thumb" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
