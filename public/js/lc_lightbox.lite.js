		...
		$(document).on('click', '.lcl_socials', function (e) {
			...
			if (!$('.lcl_socials > div').length) {
				...
				if (lcl_curr_opts.fb_share_params) {
					...
					code += '<a class="lcl_icon lcl_fb" onClick="window.open(\'#sharer?u=' + share_url + '&display=popup\',\'sharer\',\'toolbar=0,status=0,width=590,height=500\');" href="javascript: void(0)"></a>';
				} else {
					code += '<a class="lcl_icon lcl_fb" onClick="window.open(\'#sharer?u=' + page_url + '&display=popup\',\'sharer\',\'toolbar=0,status=0,width=590,height=325\');" href="javascript: void(0)"></a>';
				}
